# ============================================================
# 22_ac_ideology_bjp_fdi_interactions_v1_2.R
#
# Assembly-constituency models of BJP voting by ideological group.
# Revision: 2026-08-20-v1.2
#
# Core question:
...
SCRIPT_REVISION <- "2026-08-20-v1.2-ideology-bjp-ac-fdi-sparse-match-safe"
...
out_root <- file.path(
  paths$derived_dir,
  "model_exploration",
  "ac_ideology_bjp_fdi_interactions_v1_2"
)
...
ideology_distribution_by_year <- nes_fresh |>
  dplyr::filter(!is.na(ideology_main)) |>
  dplyr::count(
    year,
    ideology_main,
    name = "n_respondents"
