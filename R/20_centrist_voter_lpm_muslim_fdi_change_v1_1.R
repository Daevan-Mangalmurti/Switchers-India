# ============================================================
# 20_centrist_voter_lpm_muslim_fdi_change_v1_1.R
...
FDI_CHANGE <- "log1p_fdi_mfg_local_all_pc100k_2014"
...
readr::write_csv(
  tibble::tibble(
    ...
    model_unit = c(
      "percentage points",
      "change in log(1 + manufacturing projects per 100,000)",
      "100,000 persons",
      "percentage points",
      "percentage points"
    )
...
table_lines <- c(
  ...
  "\\item Muslim share is the 2001 Muslim population share expressed in percentage points. Manufacturing FDI is the change in log(1 + local manufacturing projects per 100,000 residents) from the 2004--09 exposure window to the 2009--14 exposure window.",
